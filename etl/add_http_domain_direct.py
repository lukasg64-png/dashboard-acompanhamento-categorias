...
async def main():
    print("======================================================================")
    print("  ADICIONANDO DOMINIO HTTP PURO VIA INPUT COMPLETO NO COOLIFY")
    print("======================================================================")
    ...
    async with async_playwright() as p:
        ...
        if add_btn:
            ...
            # Preencher o input de domínio com o prefixo http:// explicito
            print("  Preenchendo input de domínio com http://categorias.10.200.12.69.sslip.io...")
            domain_inp = await page.wait_for_selector('input[placeholder*="example"]', timeout=5000)
            if domain_inp:
                await domain_inp.fill("http://categorias.10.200.12.69.sslip.io")
                await page.wait_for_timeout(1000)
        ...
        await page.screenshot(path='logs/coolify_http_domain_result.png')
        print("  Screenshot salvo em: logs/coolify_http_domain_result.png")
