...
async def main():
    print("======================================================================")
    print("  CLICANDO EM CONTINUE E SALVANDO O DOMINIO NO COOLIFY")
    print("======================================================================")
    ...
    async with async_playwright() as p:
        ...
        # Se houver o modal aberto ou para abrir
        add_btn = await page.query_selector('button:has-text("Add")')
        if add_btn:
            await add_btn.click(force=True)
            await page.wait_for_timeout(1000)

            # Preencher protocolo http e dominio
        ...
        # Clicar em Continue se houver o modal de aviso DNS via JS
        print("  Procurando botão 'Continue' no modal via JS...")
        await page.evaluate('''() => {
        ...
        await page.screenshot(path='logs/coolify_domain_added_success.png')
        print("  Screenshot após salvar domínio em: logs/coolify_domain_added_success.png")
